...
var writeSwitchMap = map[int]Switch{
	...
	// Display switches
	0xC000: {Mode: ModeW, Name: "80STORE", Description: "off: disallow PAGE2 from control of display memory"},
	0xC001: {Mode: ModeW, Name: "80STORE", Description: "on: allow PAGE2 to control display memory"},
	...
	0xC055: {Mode: ModeRW, Name: "PAGE2", Description: "on: select display page 2 or, if 80STORE on, display page 1 in auxiliary memory"},
