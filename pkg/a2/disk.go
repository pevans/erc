...
func diskReadWrite(addr int, val *uint8, stm *data.StateMap) {
	var (
		nib = addr & 0xF
...
func diskRead(addr int, stm *data.StateMap) uint8 {
...
func diskWrite(addr int, val uint8, stm *data.StateMap) {
